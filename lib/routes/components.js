...
function routes(router) {
  ...
  router.all('/:name@list', responses.acceptJSONOnly);
  router.all('/:name@list', responses.methodNotAllowed({allow: ['get']}));
  router.get('/:name@list', responses.tieredList());
  ...
  router.all('/:name/instances@list', responses.acceptJSONOnly);
  router.all('/:name/instances@list', responses.methodNotAllowed({allow: ['get']}));
  router.get('/:name/instances@list', responses.tieredList());
  ...
  router.all('/:name/instances/:id@list', responses.acceptJSONOnly);
  router.all('/:name/instances/:id@list', responses.methodNotAllowed({allow: ['get']}));
  router.get('/:name/instances/:id@list', responses.tieredList());
